 ...
 * observable subject. An object that implements {@link EasySCP_Exception_Writer}
 ...
 * class notify all these writers by passing the EasySCP_Exception_Handler
 ...
 *
 * In production, a secondary {@link EasySCP_Exception_Production} object is
 ...
 * {@link EasySCP_Exception_Production exception} was created and how to get it.
 *
 ...
 * <b>Usage example:</b>
 * <code>
 * EasySCP_Exception_Handler::getInstance()->attach(
 *  new EasySCP_Exception_Writer_Browser(
 *		'themes/default/system-message.tpl'
 *  )
 * );
 * </code>
 *
 ...
 *
 *  1. We create an instance of the {@link EasySCP_Exception_Handler} class
 *  2. We attach an {@link EasySCP_Exception_Writer} that will listen this class
 *
 * See ispCP/Exception/Writer for a list of availables
 *	{@link EasySCP_Exception_Writer writers}.
 *
 * <b>Note:</b>
 *
 ...
 * {@link EasySCP_Exception_Handler::attach()} method.
 *
 * @category	ispCP
 * @package		EasySCP_Exception
 * @subpackage	Handler
 ...
 * @version		1.0.3
 */
class EasySCP_Exception_Handler implements SplSubject, IteratorAggregate, Countable {

	/**
	 * Instance of this class
	 *
	 * @var EasySCP_Exception_Handler
	 */
	 ...
	 *
	 * This variable can contains an {@link EasySCP_Exception_Production} object
	 * depending of the current execution context (Development|Production)
	 *
	 * @see getProductionException()
	 * @var EasySCP_Exception_Production
	 */
	 ...
	 *
	 * This storage contains all {@link EasySCP_Exception_Writer} objects.
	 *
	...
	/**
	 * Get an EasySCP_Exception_Handler instance
	 *
	 * Returns an {@link EasySCP_Exception_Handler} instance, only creating it if
	 * it doesn't already exist.
	 *
	 * @return EasySCP_Exception_Handler
	 */
	 ...
	 * @return EasySCP_Exception_Handler|null
	 */
	 ...
	 * EasySCP_Exception_Production object. This exception should be used by all
	...
	public function exceptionHandler(Exception $exception) {
		...
		if(error_reporting() == 0 || !ini_get('display_errors')) {
			...
			if($exception instanceof EasySCP_Exception_Production) {
				$this->_exception = $exception;
			} else {
				$this->_exception = $exception;
				$this->_productionException = new EasySCP_Exception_Production();
			}
		} else {
			$this->_exception = $exception;
		}
	 ...
	 *
	 * This methods should be used by the {@link EasySCP_Exception_Writer} writers
	 * to get the exception raised.
	 *
	 * @return Exception The EasySCP_Exception if exists; FALSE otherwise
	 */
	...
	/**
	 * Accessor method to get the EasySCP_Exception_Production object
	 *
	 * <b>Note:</b> The {@link EasySCP_Exception_Production} is only raised in
	 * production.
	 *
	 * @return EasySCP_Exception_Production|false
	 */
	 ...
	 *
	 * @param EasySCP_Exception_Writer $writer Writer that listen events of this
	 * object
	 * @return EasySCP_Exception_Handler The EasySCP_Exception_Handler instance
	 */
		...
		foreach ($this as $writer) {
			try {
				...
				if(!count($this)) {
					...
					$this->exceptionHandler(new EasySCP_Exception($message));
					die();
				}
			}
		}
