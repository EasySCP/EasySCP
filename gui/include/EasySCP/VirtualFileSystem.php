 ...
 *
 * @category	EasySCP
 * @package		EasySCP_VirtualFileSystem
 * @copyright 	2006-2011 by ispCP | http://isp-control.net
 * @version 	SVN: $Id: VirtualFileSystem.php 3762 2011-01-14 08:43:43Z benedikt $
 ...
 * files from the EasySCP control Panel.
 *
 * @category	EasySCP
 * @package		EasySCP_VirtualFileSystem
 * @author 		EasySCP Team
 */
class EasySCP_VirtualFileSystem {
	/*
	...
	/**
	 * Sets EasySCP DB handler used by this class
	 *
	 *
	 * @param EasySCP_Database $db EasySCP_Database database instance
	 * @return void
	 */
	...
	public function open() {
		...
		// Check if we have a valid EasySCP database
		if (!$this->_db) {
			return false;
		}
		...
		// TODO: Prüfen wegen IPv6
		// Temporär auf "127.0.0.1" gesetzt um Probleme bei der Verzeichnisauswahl zu umgehen.
