...
/**
 * EasySCP jQuery Tooltips plugin
 *
 ...
 * 	$('#id_link').EasySCPtooltips();
 *
 * 3. Tooltip for user helping with custom message
 * 	$('#id_img').EasySCPtooltips({msg:'Welcome in our world'});
 *
 * 4. Tooltip for user helping on password input fields with custom message
 *	$(':password').EasySCPtooltips({msg:'Please, enter your password here'});
 *
...
(function($){
	...
	$.fn.EasySCPtooltips = function(settings) {
...
})(jQuery); // EasySCP plugin tooltips
