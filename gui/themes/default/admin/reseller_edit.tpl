...
{block name=CONTENT_HEADER}{$TR_EDIT_RESELLER}{/block}
...
<form action="/admin/reseller_edit.php" method="post" id="admin_edit_reseller">
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td><input type="password" name="pass0" id="pass0" value="{$VAL_PASSWORD}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="radio" name="support_system" id="support_system_yes" value="yes" {$SUPPORT_SYSTEM_YES} /><label for="support_system_yes"> {$TR_YES}</label>
					<input type="radio" name="support_system" id="support_system_no" value="no" {$SUPPORT_SYSTEM_NO} /><label for="support_system_no"> {$TR_NO}</label>
				</td>
			</tr>
		</table>
	</fieldset>
