...
{if isset($ISACTIVE_SQL)}
	<li>
		<a href="sql_manage.php" title="{$TR_MENU_MANAGE_SQL}" class="database icon_link">{$TR_MENU_MANAGE_SQL}</a>
		<ul>
...
{/if}
	...
	<li class="menuLeft_expand">
		<a href="domain_statistics.php" title="{$TR_MENU_DOMAIN_STATISTICS}" class="statistics_active icon_link">{$TR_MENU_DOMAIN_STATISTICS}</a>
		<ul>
