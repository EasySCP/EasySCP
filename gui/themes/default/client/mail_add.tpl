...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		// Tooltips - begin
		jQuery('#fwd_help').EasySCPtooltips({ msg:"{$TR_FWD_HELP}"});
		// Tooltips - end
	});
...
{block name=CONTENT_HEADER}{$TR_MENU_ADD_MAIL_USER}{/block}
...
<form action="/client/mail_add.php" method="post" id="client_mail_add">
	<table>
		<tr>
			<td>{$TR_USERNAME}</td>
