...
"body"==g?"block":"none",d&&(d.style.display="message"==g?"block":"none"));r&&(r.style.display="currentdate"==g||"date"==g?"inline":"none");s&&(s.style.display="date"==g?"":"none");$('[value="exists"],[value="notexists"]',n).prop("disabled","string"==g);n.val()||n.val("contains");rule_op_select(e,a,g);rule_mod_select(a,g);b.style.width="..."==g?"40px":""}
...
rcube_webmail.prototype.managesieve_tip_register=function(a){var b,c=parent.rcmail,d=c?parent.rcmail.env.ms_tip_layer:rcmail.env.ms_tip_layer;for(b in a)$("#"+a[b][0]).data("tip",a[b][1]).mouseleave(function(a){d.hide()}).mouseenter(function(a){a=$(this);var b=a.offset(),l=b.left,k=b.top-12,m=a.width();c&&(b=$("mail"==rcmail.env.task?"#sievefilterform > iframe":"#filter-box",parent.document).offset(),k+=b.top,l+=b.left);d.html(a.data("tip"));k-=d.height();d.css({left:l,top:k,minWidth:m-2+"px"}).show()})};
function sieve_formattime(a,b){var c,d,e="",f=rcmail.env.time_format||"H:i";for(c=0;c<f.length;c++)switch(d=f.charAt(c),d){case "a":e+=12<=a?"pm":"am";break;case "A":e+=12<=a?"PM":"AM";break;case "g":case "h":e+=("h"==d&&10>a?"0":"")+a;break;case "G":e+=a;break;case "H":e+=(10>a?"0":"")+a;break;case "i":e+=(10>b?"0":"")+b;break;case "s":e+="00";default:e+=d}return e}
