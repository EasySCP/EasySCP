...
$("<li>");var e=$('<a href="#"></a>').text(rcmail.env.spell_langs[i]).addClass("active").data("lang",i).click(function(){rcmail.spellcheck_lang_set($(this).data("lang"))});e.appendTo(f);f.appendTo(d)}d.appendTo(c)}$("li",d).each(function(){var a=$("a",this);a.data("lang")==b?a.addClass("selected"):a.hasClass("selected")&&a.removeClass("selected")});this.show_popupmenu("spellmenu",a)},show_attachmentmenu:function(a,b){var c=a.parentNode.id.replace(/^attach/,"");$("#attachmenuopen").off("click").attr("onclick",
...
next_sibling:function(a){for(a=a.nextSibling;a&&3==a.nodeType;)a=a.nextSibling;return a},prev_sibling:function(a){for(a=a.previousSibling;a&&3==a.nodeType;)a=a.previousSibling;return a},enable_command:function(a){"reply-list"==a.command&&1==rcmail.env.reply_all_mode?(a=rcmail.gettext(a.status?"replylist":"replyall"),$("a.button.replyAll").attr("title",a)):"compose-encrypted"==a.command&&$("#messagetoolbar > a.encrypt").show()},folder_search_init:function(a){$(".boxtitle a.search",a).click(function(b){var c=
$(".boxtitle",a),d=$(".listsearchbox",a),f=d.is(":visible")?-1:1,e=24+($("select",d).length?24:0);d.slideToggle({duration:160,progress:function(b,d){0>f&&(d=1-d);$(".boxlistcontent",a).css("top",c.outerHeight()+e*d+"px")},complete:function(){d.toggleClass("expanded");d.is(":visible")?d.find("input[type=text]").focus():$("a.reset",d).click()}});return!1})}};
