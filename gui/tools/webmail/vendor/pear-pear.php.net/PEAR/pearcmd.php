...
if ('/www/roundcube/releases/roundcubemail-1.1.6/vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/www/roundcube/releases/roundcubemail-1.1.6/vendor/pear-pear.php.net/PEAR '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
