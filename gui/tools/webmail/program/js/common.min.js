...
rcube_parse_query=function(a){if(!a)return{};var b={},c,d=/([^&=]+)=?([^&]*)/g,e=/\+/g;for(a=a.replace(/\?/,"");c=d.exec(a);){var f=decodeURIComponent(c[1].replace(e," "));c=decodeURIComponent(c[2].replace(e," "));"[]"===f.substring(f.length-2)?(f=f.substring(0,f.length-2),(b[f]||(b[f]=[])).push(c)):b[f]=c}return b};
var Base64=function(){var a=function(a){var b=0,d="";for(c2=c3=0;b<a.length;){var e=a.charCodeAt(b);128>e?(d+=String.fromCharCode(e),b++):191<e&&224>e?(c2=a.charCodeAt(b+1),d+=String.fromCharCode((e&31)<<6|c2&63),b+=2):(c2=a.charCodeAt(b+1),c3=a.charCodeAt(b+2),d+=String.fromCharCode((e&15)<<12|(c2&63)<<6|c3&63),b+=3)}return d};return{encode:function(a){a=a.replace(/\r\n/g,"\n");for(var b="",d=0;d<a.length;d++){var e=a.charCodeAt(d);128>e?b+=String.fromCharCode(e):(127<e&&2048>e?b+=String.fromCharCode(e>>
6|192):(b+=String.fromCharCode(e>>12|224),b+=String.fromCharCode(e>>6&63|128)),b+=String.fromCharCode(e&63|128))}a=b;if("function"===typeof window.btoa)try{return btoa(a)}catch(n){}for(var f,g,h,k=0,l="",m=a.length;k<m;)f=a.charCodeAt(k++),b=a.charCodeAt(k++),d=a.charCodeAt(k++),e=f>>2,f=(f&3)<<4|b>>4,g=(b&15)<<2|d>>6,h=d&63,isNaN(b)?g=h=64:isNaN(d)&&(h=64),l=l+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h);return l},decode:function(b){if("function"===typeof window.atob)try{return a(atob(b))}catch(m){}var c,d=0,e="";b=b.replace(/[^A-Za-z0-9\+\/=]/g,"");for(c=b.length;d<c;){var f="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(d++));var g="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(d++));
var h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(d++));var k="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(b.charAt(d++));f=f<<2|g>>4;g=(g&15)<<4|h>>2;var l=(h&3)<<6|k;e+=String.fromCharCode(f);64!=h&&(e+=String.fromCharCode(g));64!=k&&(e+=String.fromCharCode(l))}return a(e)}}}();
