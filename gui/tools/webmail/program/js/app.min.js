...
this.init_messageform();else if("get"==this.env.action)if(this.enable_command("download",!0),bw.mz&&"application/pdf"==this.env.mimetype){var a=0;$(this.gui_objects.messagepartframe).on("load",function(){if(a++)try{this.contentWindow.document,f.enable_command("print",!0)}catch(h){}})}else this.enable_command("print",!0);else"print"!=this.env.action||!this.env.uid||this.env.is_pgp_content||this.env.pgp_mime_part||this.print_dialog();this.gui_objects.mailboxlist&&(this.env.unread_counts={},this.gui_objects.folderlist=
...
for(a in this.onloads)if("string"===typeof this.onloads[a])eval(this.onloads[a]);else if("function"===typeof this.onloads[a])this.onloads[a]();this.start_refresh();this.start_keepalive()}else this.goto_url("error","_code=0x199")};this.log=function(a){window.console&&console.log&&console.log(a)};this.command=function(a,b,d,e){var g,k=!1;!d||!d.blur||e&&rcube_event.is_keyboard(e)||d.blur();if(this.busy&&("reset-search"!=a||"search"!=this.last_command)&&!a.match(/^menu-/))return!1;if(d&&d.href&&0>String(d.href).indexOf("#")&&
rcube_event.get_modifier(e))return!0;if(!this.commands[a])return this.is_framed()&&parent.rcmail.command(a,b),!1;if("mail"==this.task&&"compose"==this.env.action&&!this.env.server_error&&"save-pref"!=a&&0>$.inArray(a,this.env.compose_commands)){if(!this.env.is_sent&&this.cmp_hash!=this.compose_field_hash()&&!confirm(this.get_label("notsentwarning")))return!1;this.remove_compose_data(this.env.compose_id);this.compose_skip_unsavedcheck=!0}this.last_command=a;if("function"===typeof this.command_handlers[a]){var h=
this.command_handlers[a](b,d,e);return void 0!==h?h:d?!1:!0}if("string"===typeof this.command_handlers[a])return h=window[this.command_handlers[a]](b,d,e),void 0!==h?h:d?!1:!0;this.triggerEvent("actionbefore",{props:b,action:a,originalEvent:e});h=this.triggerEvent("before"+a,b||e);if(void 0!==h){if(!1===h)return!1;b=h}h=void 0;switch(a){case "login":this.gui_objects.loginform&&this.gui_objects.loginform.submit();break;case "logout":case "mail":case "addressbook":case "settings":this.switch_task(a);
break;case "about":this.redirect("?_task=settings&_action=about",!1);break;case "permaurl":if(d&&d.href&&d.target)return!0;this.env.permaurl&&(parent.location.href=this.env.permaurl);break;case "extwin":if("compose"==this.env.action){if(e=this.gui_objects.messageform,g=this.open_window(""))this.save_compose_form_local(),this.compose_skip_unsavedcheck=!0,$("input[name='_action']",e).val("compose"),e.action=this.url("mail/compose",{_id:this.env.compose_id,_extwin:1}),e.target=g.name,e.submit()}else this.open_window(this.env.permaurl,
!0);break;case "change-format":e=this.env.permaurl+"&_format="+b;"preview"==this.env.action&&(e=e.replace(/_action=show/,"_action=preview")+"&_framed=1");this.env.extwin&&(e+="&_extwin=1");location.href=e;break;case "menu-open":b&&"attachmentmenu"==b.menu&&(g=this.env.attachments[b.id],this.enable_command("open-attachment",g&&this.env.mimetypes&&0<=$.inArray(g,this.env.mimetypes)));this.show_menu(b,b.show||void 0,e);break;case "menu-close":this.hide_menu(b,e);break;case "menu-save":return this.triggerEvent(a,
...
(e=this.upload_file(b||this.gui_objects.uploadform,"upload"))||(!1!==e&&alert(this.get_label("selectimportfile")),k=!0);break;case "insert-sig":this.change_identity($("[name='_from']")[0],!0);break;case "list-addresses":this.list_contacts(b);this.enable_command("add-recipient",!1);break;case "add-recipient":this.compose_add_recipient(b);break;case "reply-all":case "reply-list":case "reply":if(g=this.get_single_uid())e={_reply_uid:g,_mbox:this.get_message_mailbox(g),_search:this.env.search_request},
"reply-all"==a?e._all=!b&&1==this.env.reply_all_mode&&this.commands["reply-list"]?"list":"all":"reply-list"==a&&(e._all="list"),this.open_compose_step(e);break;case "forward-attachment":case "forward-inline":case "forward":g=this.env.uid?[this.env.uid]:this.message_list?this.message_list.get_selection():[];if(g.length){e={_forward_uid:this.uids_to_list(g),_mbox:this.env.mailbox,_search:this.env.search_request};if("forward-attachment"==a||!b&&this.env.forward_attachment||1<g.length)e._attachment=1;
this.open_compose_step(e)}break;case "print":if("addressbook"==this.task){if(g=this.contact_list.get_single_selection())e="&_action=print&_cid="+g,this.env.source&&(e+="&_source="+urlencode(this.env.source)),this.open_window(this.env.comm_path+e,!0,!0)}else if("get"==this.env.action)this.gui_objects.messagepartframe.contentWindow.print();else if(g=this.get_single_uid())e=this.url("print",this.params_from_uid(g,{_safe:this.env.safemode?1:0})),this.open_window(e,!0,!0)&&"show"!=this.env.action&&this.mark_message("read",
g);break;case "viewsource":(g=this.get_single_uid())&&this.open_window(this.url("viewsource",this.params_from_uid(g)),!0,!0);break;case "download":"get"==this.env.action?location.href=this.secure_url(location.href.replace(/_frame=/,"_download=")):(g=this.get_single_uid())&&this.goto_url("viewsource",this.params_from_uid(g,{_save:1}),!1,!0);break;case "search":if(!b&&this.gui_objects.qsearchbox&&(b=this.gui_objects.qsearchbox.value),b){this.qsearch(b);break}case "reset-search":var m;e=this.env.search_request||
this.env.qsearch;this.reset_qsearch(!0);if(e&&"compose"==this.env.action)this.contact_list&&this.list_contacts_clear();else if(e&&this.env.mailbox)this.list_mailbox(this.env.mailbox,1);else if(e&&"addressbook"==this.task){if(""==this.env.source){for(m in this.env.address_sources)break;this.env.source=m;this.env.group=""}this.list_contacts(this.env.source,this.env.group,1)}break;case "pushgroup":var q={id:b.id,search_request:this.env.search_request,page:this.env.current_page,search:this.env.search_request&&
this.gui_objects.qsearchbox?this.gui_objects.qsearchbox.value:null};this.env.address_group_stack.push(q);d&&e&&rcube_event.cancel(e);case "listgroup":this.reset_qsearch();this.list_contacts(b.source,b.id,1,q);break;case "popgroup":this.env.address_group_stack.length&&(e=this.env.address_group_stack.pop(),this.reset_qsearch(),e.search_request?(e.search&&this.gui_objects.qsearchbox&&$(this.gui_objects.qsearchbox).val(e.search),this.env.search_request=e.search_request,this.list_contacts_remote(null,
...
d.parent_uid:0,selected:this.select_all_mode||this.message_list.in_selection(a),ml:d.ml?1:0,ctype:d.ctype,mbox:d.mbox,flags:d.extra_flags});var g,k="",f="",l="",n="",m=this.message_list,q=m.rows;var p=this.env.messages[a];var u=this.html_identifier(a,!0),v="message"+(d.seen?"":" unread")+(d.deleted?" deleted":"")+(d.flagged?" flagged":"")+(p.selected?" selected":""),x={cols:[],style:{},id:"rcmrow"+u,uid:a};var t="msgicon";null===this.env.status_col&&(t+=" status",d.deleted?(k+=" deleted",f+=this.get_label("deleted")+
" "):d.seen?0<d.unread_children&&(k+=" unreadchildren"):(k+=" unread",f+=this.get_label("unread")+" "));d.answered&&(k+=" replied",f+=this.get_label("replied")+" ");d.forwarded&&(k+=" forwarded",f+=this.get_label("forwarded")+" ");p.selected&&!m.in_selection(a)&&m.selection.push(a);this.env.threading&&(p.depth?(l+='<span id="rcmtab'+u+'" class="branch" style="width:'+15*p.depth+'px;">&nbsp;&nbsp;</span>',q[p.parent_uid]&&!1===q[p.parent_uid].expanded||!(0!=this.env.autoexpand_threads&&2!=this.env.autoexpand_threads||
q[p.parent_uid]&&q[p.parent_uid].expanded)?(x.style.display="none",p.expanded=!1):p.expanded=!0,v+=" thread expanded"):p.has_children&&(void 0===p.expanded&&(1==this.env.autoexpand_threads||2==this.env.autoexpand_threads&&p.unread_children)&&(p.expanded=!0),n='<div id="rcmexpando'+x.id+'" class="'+(p.expanded?"expanded":"collapsed")+'">&nbsp;&nbsp;</div>',v+=" thread"+(p.expanded?" expanded":"")),d.unread_children&&d.seen&&!p.expanded&&(v+=" unroot"));l+='<span id="msgicn'+x.id+'" class="'+t+k+'" title="'+
f+'"></span>';x.className=v;b.subject&&(t=d.mbox==this.env.drafts_mailbox?"compose":"show",f={_mbox:d.mbox},f[d.mbox==this.env.drafts_mailbox?"_draft_uid":"_uid"]=a,b.subject='<a href="'+this.url(t,f)+'" onclick="return rcube_event.keyboard_only(event)" onmouseover="rcube_webmail.long_subject_title(this,'+(p.depth+1)+')" tabindex="-1"><span>'+b.subject+"</span></a>");for(g in this.env.listcols)t=this.env.listcols[g],a={className:String(t).toLowerCase(),events:{}},this.env.coltypes[t]&&this.env.coltypes[t].hidden&&
(a.className+=" hidden"),"flag"==t?(t=d.flagged?"flagged":"unflagged",p=this.get_label(t),t='<span id="flagicn'+x.id+'" class="'+t+'" title="'+p+'"></span>'):"attachment"==t?(p=this.get_label("withattachment"),t=d.attachmentClass?'<span class="'+d.attachmentClass+'" title="'+p+'"></span>':/application\/|multipart\/(m|signed)/.test(d.ctype)?'<span class="attachment" title="'+p+'"></span>':/multipart\/report/.test(d.ctype)?'<span class="report"></span>':"&nbsp;"):"status"==t?(p="",d.deleted?(t="deleted",
p=this.get_label("deleted")):d.seen?t=0<d.unread_children?"unreadchildren":"msgicon":(t="unread",p=this.get_label("unread")),t='<span id="statusicn'+x.id+'" class="'+t+k+'" title="'+p+'"></span>'):"threads"==t?t=n:"subject"==t?(bw.ie&&(a.events.mouseover=function(){rcube_webmail.long_subject_title_ex(this)}),t=l+b[t]):"priority"==t?0<d.prio&&6>d.prio?(p=this.get_label("priority")+" "+d.prio,t='<span class="prio'+d.prio+'" title="'+p+'"></span>'):t="&nbsp;":t="folder"==t?'<span onmouseover="rcube_webmail.long_subject_title(this)">'+
b[t]+"<span>":b[t],a.innerHTML=t,x.cols.push(a);m.insert_row(x,e);e&&this.env.pagesize&&m.rowcount>this.env.pagesize&&(a=m.get_last_row(),m.remove_row(a),m.clear_selection(a))};this.set_list_sorting=function(a,b){var d="arrival"==a?"date":a;$("#rcm"+("arrival"==this.env.sort_col?"date":this.env.sort_col)).removeClass("sorted"+this.env.sort_order.toUpperCase());d&&$("#rcm"+d).addClass("sorted"+b);$("#rcmdate > a").prop("rel","arrival"==a?"arrival":"date");this.env.sort_col=a;this.env.sort_order=b};
this.set_list_options=function(a,b,d,e){var g={};void 0===b&&(b=this.env.sort_col);d||(d=this.env.sort_order);if(this.env.sort_col!=b||this.env.sort_order!=d){var f=1;this.set_list_sorting(b,d)}this.env.threading!=e&&(f=1,g._threads=e);if(a&&a.length){var h=[],l=this.env.listcols;for(e=0;e<l.length;e++){var n=l[e];var m=$.inArray(n,a);-1!=m&&(h.push(n),delete a[m])}for(e=0;e<a.length;e++)a[e]&&h.push(a[e]);h.join()!=l.join()&&(f=1,g._cols=h.join(","))}f&&this.list_mailbox("","",b+"_"+d,g)};this.show_message=
function(a,b,d){if(a){var e,g=window,k=this.params_from_uid(a,{_caps:this.browser_capabilities()});d&&(e=this.get_frame_window(this.env.contentframe))&&(g=e,k._framed=1);b&&(k._safe=1);this.env.search_request&&(k._search=this.env.search_request);this.env.extwin&&(k._extwin=1);k=this.url(d?"preview":"show",k);d&&0<=String(g.location.href).indexOf(k)?this.show_contentframe(!0):(d||!this.env.message_extwin||this.env.extwin?this.location_href(k,g,!0):this.open_window(k,!0),d&&this.message_list&&this.message_list.rows[a]&&
...
(e._search=this.env.search_request);if(!g){this.clear_message_list();if(a!=this.env.mailbox||a==this.env.mailbox&&!b&&!d)e._refresh=1;this.select_folder(a,"",!0);this.unmark_folder(a,"recent","",!0);this.env.mailbox=a}if(this.gui_objects.messagelist)this.list_mailbox_remote(a,b,e);else{if(d=this.get_frame_window(this.env.contentframe))f=d,e._framed=1;this.env.uid&&(e._uid=this.env.uid);a&&(this.set_busy(!0,"loading"),e._mbox=a,b&&(e._page=b),this.location_href(e,f))}};this.clear_message_list=function(){this.env.messages=
...
this.env.autoexpand_threads&&this.message_list)switch(this.env.autoexpand_threads){case 2:this.expand_unread();break;case 1:this.message_list.expand_all()}};this.init_threads=function(a,b){if(b&&b!=this.env.mailbox)return!1;b=0;for(var d=a.length;b<d;b++)this.add_tree_icons(a[b]);this.expand_threads()};this.add_tree_icons=function(a){var b,d,e=[],g=[],f,h=this.message_list.rows;for(f=a?h[a]?h[a].obj:null:this.message_list.tbody.firstChild;f;){if(1==f.nodeType&&(d=h[f.uid]))if(d.depth){for(b=e.length-
1;0<=b;b--){var l=e[b].length;if(l>d.depth){var n=l-d.depth;e[b][n]&2||(e[b][n]=e[b][n]?e[b][n]+2:2)}else l==d.depth&&(e[b][0]&2||(e[b][0]+=2));if(d.depth>l)break}e.push(Array(d.depth));e[e.length-1][0]=1;g.push(d.uid)}else{if(e.length){for(b in e)this.set_tree_icons(g[b],e[b]);e=[];g=[]}if(a&&f!=h[a].obj)break}f=f.nextSibling}if(e.length)for(b in e)this.set_tree_icons(g[b],e[b])};this.set_tree_icons=function(a,b){var d,e=[],g="",f=b.length;for(d=0;d<f;d++)2<b[d]?e.push({"class":"l3",width:15}):1<
b[d]?e.push({"class":"l2",width:15}):0<b[d]?e.push({"class":"l1",width:15}):e.length&&!e[e.length-1]["class"]?e[e.length-1].width+=15:e.push({"class":null,width:15});for(d=e.length-1;0<=d;d--)g=e[d]["class"]?g+('<div class="tree '+e[d]["class"]+'" />'):g+('<div style="width:'+e[d].width+'px" />');g&&$("#rcmtab"+this.html_identifier(a,!0)).html(g)};this.update_thread_root=function(a,b){if(this.env.threading){var d=this.message_list.find_root(a);if(a!=d){a=this.message_list.rows[d];if("read"==b&&a.unread_children)a.unread_children--;
else if("unread"==b&&a.has_children)a.unread_children=a.unread_children?a.unread_children+1:1;else return;this.set_message_icon(d);this.set_unread_children(d)}}};this.update_thread=function(a){if(!this.env.threading)return 0;var b,d=0,e=this.message_list.rows,g=e[a],k=e[a].depth,h=[];g.depth?g.unread&&(a=this.message_list.find_root(a),e[a].unread_children--,this.set_unread_children(a)):d--;a=g.parent_uid;for(g=g.obj.nextSibling;g;){if(1==g.nodeType&&(b=e[g.uid])){if(!b.depth||b.depth<=k)break;b.depth--;
$("#rcmtab"+b.id).width(15*b.depth).html("");b.depth?(b.depth==k&&(b.parent_uid=a),b.unread&&h.length&&h[h.length-1].unread_children++):(d++,b.parent_uid=0,b.has_children&&($("#"+b.id+" .leaf:first").attr("id","rcmexpando"+b.id).attr("class","none"!=b.obj.style.display?"expanded":"collapsed").mousedown({uid:b.uid},function(a){return f.expand_message_row(a,a.data.uid)}),b.unread_children=0,h.push(b)),"none"==b.obj.style.display&&$(b.obj).show())}g=g.nextSibling}for(b=0;b<h.length;b++)this.set_unread_children(h[b].uid);
...
return!0};this.permanently_remove_messages=function(){var a=this.selection_post_data();a._uid&&(this.show_contentframe(!1),this._with_selected_messages("delete",a))};this._with_selected_messages=function(a,b,d){var e=0,g="delete"==a||!this.is_multifolder_listing();if(this.message_list){var f=[],h=this.message_list.get_selection();var l=0;for(len=h.length;l<len;l++){var n=h[l];if(this.env.threading){e+=this.update_thread(n);var m=this.message_list.find_root(n);m!=n&&0>$.inArray(m,f)&&f.push(m)}g&&
this.message_list.remove_row(n,this.env.display_next&&l==h.length-1)}!this.env.display_next&&g&&this.message_list.clear_selection();l=0;for(len=f.length;l<len;l++)this.add_tree_icons(f[l])}0>e?b._count=-1*e:0<e&&g&&this.delete_excessive_thread_rows();g||(b._refresh=1);d||(d=this.display_message(this.get_label("move"==a?"movingmessage":"deletingmessage"),"loading"));this.http_post(a,b,d)};this.selection_post_data=function(a){"object"!=typeof a&&(a={});a._mbox=this.env.mailbox;if(!a._uid){var b=this.env.uid?
[this.env.uid]:this.message_list.get_selection();a._uid=this.uids_to_list(b)}this.env.action&&(a._from=this.env.action);this.env.search_request&&(a._search=this.env.search_request);this.env.display_next&&this.env.next_uid&&(a._next_uid=this.env.next_uid);return a};this.mark_message=function(a,b){var d=[],e=[],g=this.message_list;b?d[0]=b:this.env.uid?d[0]=this.env.uid:g&&(d=g.get_selection());if(g){g.focus();var f=0;for(b=d.length;f<b;f++){var h=d[f];("read"==a&&g.rows[h].unread||"unread"==a&&!g.rows[h].unread||
"delete"==a&&!g.rows[h].deleted||"undelete"==a&&g.rows[h].deleted||"flagged"==a&&!g.rows[h].flagged||"unflagged"==a&&g.rows[h].flagged)&&e.push(h)}}else e=d;if(e.length||this.select_all_mode)switch(a){case "read":case "unread":this.toggle_read_status(a,e);break;case "delete":case "undelete":this.toggle_delete_status(e);break;case "flagged":case "unflagged":this.toggle_flagged_status(a,d)}};this.toggle_read_status=function(a,b){var d,e=b.length,g=this.selection_post_data({_uid:this.uids_to_list(b),
...
d+"</li>";e='<ul class="toolbarmenu">'+e+"</ul>";f.pagejump||(f.pagejump=$('<div id="pagejump-selector" class="popupmenu"></div>').appendTo(document.body).on("click","li",function(){f.busy||$(a).val($(this).text()).change()}));f.pagejump.data("count")!=d&&f.pagejump.html(e);f.pagejump.attr("rel","#"+this.id).data("count",d);f.show_menu("pagejump-selector",!0,b);$(this).keydown()}).on("keydown keyup click",function(b){var d=$("#pagejump-selector"),e=$("ul",d),g=$("li",e);e.height();var k=parseInt(this.value);
if(27!=b.which&&9!=b.which&&13!=b.which&&!d.is(":visible"))return f.show_menu("pagejump-selector",!0,b);if("keydown"==b.type)if(40==b.which)g.length>k&&(this.value=k+=1);else if(38==b.which)1<k&&g.length>k-1&&(this.value=--k);else{if(13==b.which)return $(this).change();if(27==b.which||9==b.which)return $(a).val(f.env.current_page)}$("li.selected",e).removeClass("selected");(b=$(g[k-1])).length&&(b.addClass("selected"),$("#pagejump-selector").scrollTop(e.height()/g.length*(k-1)-d.height()/2))}).on("change",
...
$.ajax({type:"GET",url:this.url("get",this.env.pgp_mime_message),error:function(a,b,d){f.http_error(a,b,d,k);f.enable_command("compose-encrypted",!g)},success:function(a){f.set_busy(!1,null,k);g&&(f.command("toggle-editor",{html:!1,noconvert:!0}),$("#"+f.env.composebody).val(""));f.compose_encrypted({quotedMail:a});f.enable_command("compose-encrypted",!0)}})}else this.enable_command("compose-encrypted",!g);this.addEventListener("actionafter",function(a){a.ret&&"toggle-editor"==a.action&&f.enable_command("compose-encrypted",
!a.props.html)})}};this.compose_encrypted=function(a){var b=$("#"+this.env.composebody).parent();if(f.mailvelope_editor)f.mailvelope_editor=null,f.compose_skip_unsavedcheck=!1,f.set_button("compose-encrypted","act"),b.removeClass("mailvelope").find("iframe:not([aria-hidden=true])").remove(),$("#"+f.env.composebody).show(),$("[name='_pgpmime']").remove(),f.enable_command("spellcheck","insert-sig","toggle-editor","insert-response","save-response",!0),f.triggerEvent("compose-encrypted",{active:!1});
else{this.spellcheck_state()&&this.editor.spellcheck_stop();var d=a.quotedMail?{quotedMail:a.quotedMail,quotedMailIndent:!1}:{predefinedText:$("#"+this.env.composebody).val()};"reply"==this.env.compose_mode&&(d.quotedMailIndent=!0,d.quotedMailHeader=this.env.compose_reply_header);mailvelope.createEditorContainer("#"+b.attr("id"),f.mailvelope_keyring,d).then(function(a){f.mailvelope_editor=a;f.compose_skip_unsavedcheck=!0;f.set_button("compose-encrypted","sel");b.addClass("mailvelope");$("#"+f.env.composebody).hide();
f.enable_command("spellcheck","insert-sig","toggle-editor","insert-response","save-response",!1);f.triggerEvent("compose-encrypted",{active:!0});f.env.attachments&&!$.isEmptyObject(f.env.attachments)&&(alert(f.get_label("encryptnoattachments")),$.each(f.env.attachments,function(a,b){f.remove_from_attachment_list(a)}))},function(a){console.error(a);console.log(d)})}};this.mailvelope_submit_messageform=function(a,b){var d=[];$.each(["to","cc","bcc"],function(a,b){for(b=$.trim($('[name="_'+b+'"]').val());b.length&&
rcube_check_email(b,!0);)a=RegExp.$2,d.push(a),b=b.substr(b.indexOf(a)+a.length+1).replace(/^\s*,\s*/,"")});var e=0<d.length;f.mailvelope_keyring.validKeyForAddress(d).then(function(g){var k=[];$.each(g,function(a,b){!1===b&&(e=!1,k.push(a))});if(!e&&k.length)return f.show_popup_dialog(f.get_label("nopubkeyfor").replace("$email",k.join(", "))+"<p>"+f.get_label("searchpubkeyservers")+"</p>",f.get_label("encryptedsendialog"),[{text:f.get_label("search"),"class":"mainaction",click:function(){var a=$(this);
f.mailvelope_search_pubkeys(k,function(){a.dialog("close")})}},{text:f.get_label("cancel"),click:function(){$(this).dialog("close")}}]),!1;if(!e)return d.length||(alert(f.get_label("norecipientwarning")),$("[name='_to']").focus()),!1;var h=[],l=f.env.identities[$("[name='_from'] option:selected").val()];$.each(f.env.identities,function(a,b){h.push(b.email)});f.mailvelope_keyring.validKeyForAddress(h).then(function(e){valid_sender=null;$.each(e,function(a,b){if(!1!==b&&(valid_sender=a,valid_sender==
l))return!1});if(!valid_sender&&!confirm(f.get_label("nopubkeyforsender")))return!1;d.push(valid_sender);f.mailvelope_editor.encrypt(d).then(function(d){var e=f.gui_objects.messageform,g=$("[name='_pgpmime']",e),k=f.set_busy(!0,a||b?"savingmessage":"sendingmessage");e.target="savetarget";e._draft.value=a?"1":"";e.action=f.add_url(e.action,"_unlock",k);e.action=f.add_url(e.action,"_framed",1);b&&(e.action=f.add_url(e.action,"_saveonly",1));g.length||(g=$('<input type="hidden" name="_pgpmime">').appendTo(e));
...
"error")})};this.mailvelope_search_pubkeys=function(a,b){var d=[],e=new PublicKey,g=f.display_message(f.get_label("loading"),"loading");$.each(a,function(a,b){var g=$.Deferred();e.search(b,function(a,d){null!==d?g.resolve([b]):g.resolve([b].concat(a))});d.push(g)});$.when.apply($,d).then(function(){var a=[],d=[];$.each(arguments,function(b,e){b=e.shift();e.length?d=d.concat(e):a.push(b)});f.hide_message(g);b(!0);d.length&&f.mailvelope_key_import_dialog(d);a.length&&f.display_message(f.get_label("nopubkeyfor").replace("$email",
a.join(", ")),"warning")}).fail(function(){console.error("Pubkey lookup failed with",arguments);f.hide_message(g);f.display_message("pubkeysearcherror","error");b(!1)})};this.mailvelope_key_import_dialog=function(a){var b=$("<div>").addClass("listing mailvelopekeyimport");$.each(a,function(a,e){a=$("<div>").addClass("key");e.revoked&&a.addClass("revoked");e.disabled&&a.addClass("disabled");e.expired&&a.addClass("expired");a.append($("<label>").addClass("keyid").text(f.get_label("keyid")));a.append($("<a>").text(e.keyid.substr(-8).toUpperCase()).attr("href",
e.info).attr("target","_blank").attr("tabindex","-1"));a.append($("<label>").addClass("keylen").text(f.get_label("keylength")));a.append($("<span>").text(e.keylen));e.expirationdate&&(a.append($("<label>").addClass("keyexpired").text(f.get_label("keyexpired"))),a.append($("<span>").text((new Date(1E3*e.expirationdate)).toDateString())));e.revoked&&a.append($("<span>").addClass("keyrevoked").text(f.get_label("keyrevoked")));var d=$("<ul>").addClass("uids");$.each(e.uids,function(a,b){a=$("<li>").addClass("uid");
b.revoked&&a.addClass("revoked");b.disabled&&a.addClass("disabled");b.expired&&a.addClass("expired");d.append(a.text(b.uid))});a.append(d);a.append($("<input>").attr("type","button").attr("rel",e.keyid).attr("value",f.get_label("import")).addClass("button importkey").prop("disabled",e.revoked||e.disabled||e.expired));b.append(a)});f.show_popup_dialog($("<div>").append($("<p>").html(f.get_label("encryptpubkeysfound"))).append(b),f.get_label("importpubkeys"),[{text:f.get_label("close"),click:function(){$(this).dialog("close")}}]);
b.on("click","input.button.importkey",function(){var a=$(this),b=a.attr("rel"),g=new PublicKey,k=f.display_message(f.get_label("loading"),"loading");g.get(b,function(d,e){f.hide_message(k);e?f.display_message(f.get_label("keyservererror"),"error"):f.mailvelope_keyring.importPublicKey(d).then(function(d){"REJECTED"!==d&&(d=b.substr(-8).toUpperCase(),a.closest(".key").fadeOut(),f.display_message(f.get_label("keyimportsuccess").replace("$key",d),"confirmation"))},function(a){console.log(a)})})})};this.expunge_mailbox=
function(a){var b={_mbox:a};if(a==this.env.mailbox){var d=this.set_busy(!0,"loading");b._reload=1;this.env.search_request&&(b._search=this.env.search_request)}this.http_post("expunge",b,d)};this.purge_mailbox=function(a){var b={_mbox:a};if(!confirm(this.get_label("purgefolderconfirm")))return!1;if(a==this.env.mailbox){var d=this.set_busy(!0,"loading");b._reload=1}this.http_post("purge",b,d)};this.purge_mailbox_test=function(){return this.env.exists&&(this.env.mailbox==this.env.trash_mailbox||this.env.mailbox==
...
$(window).width()),$(window).height()+24))};this.init_messageform=function(){if(!this.gui_objects.messageform)return!1;var a,b=$("[name='_from']"),d=$("[name='_to']"),e=$("input[name='_subject']"),g=$("[name='_message']").get(0),f="1"==$("input[name='_is_html']").val(),h=["cc","bcc","replyto","followupto"],l,n=this.opener();n&&"compose"==n.env.action&&(setTimeout(function(){1<opener.history.length?opener.history.back():n.redirect(n.get_task_url("mail"))},100),this.env.opened_extwin=!0);0<this.env.autocomplete_threads&&
(l={threads:this.env.autocomplete_threads,sources:this.env.autocomplete_sources});this.init_address_input_events(d,l);for(m in h)this.init_address_input_events($("[name='_"+h[m]+"']"),l);if(!f){var m=this.env.top_posting&&this.env.compose_mode?0:g.value.length;"select-one"==b.prop("type")&&(this.set_caret_pos(g,0),this.change_identity(b[0]));this.set_caret_pos(g,m);m&&$(g).scrollTop(g.scrollHeight)}this.env.save_localstorage&&this.compose_restore_dialog(0,f);""==d.val()?a=d:""==e.val()?a=e:g&&(a=
g);$(a).filter(":visible").focus();this.env.compose_focus_elem=document.activeElement;this.compose_field_hash(!0);this.auto_save_start()};this.compose_restore_dialog=function(a,b){var d,e=this.local_storage_get_item("compose.index",[]),g=function(a){++a<e.length&&f.compose_restore_dialog(a,b)};for(d=a||0;d<e.length;d++){var k=e[d];if(a=this.local_storage_get_item("compose."+k,null,!0)){if(a.changed&&k==this.env.compose_id){this.restore_compose_form(k,b);break}if(!(this.env.draft_id&&a.draft_id&&a.draft_id!=
this.env.draft_id||this.env.reply_msgid&&a.reply_msgid!=this.env.reply_msgid)&&a.changed&&a.session!=this.env.session_id){this.show_popup_dialog(this.get_label("restoresavedcomposedata").replace("$date",(new Date(a.changed)).toLocaleString()).replace("$subject",a._subject).replace(/\n/g,"<br/>"),this.get_label("restoremessage"),[{text:this.get_label("restore"),"class":"mainaction",click:function(){f.restore_compose_form(k,b);f.remove_compose_data(k);f.save_compose_form_local();$(this).dialog("close")}},
{text:this.get_label("delete"),"class":"delete",click:function(){f.remove_compose_data(k);$(this).dialog("close");g(d)}},{text:this.get_label("ignore"),click:function(){$(this).dialog("close");g(d)}}]);break}}}};this.init_address_input_events=function(a,b){this.env.recipients_delimiter=this.env.recipients_separator+" ";a.keydown(function(a){return f.ksearch_keydown(a,this,b)}).attr({autocomplete:"off","aria-autocomplete":"list","aria-expanded":"false",role:"combobox"})};this.submit_messageform=function(a,
b){var d=this.gui_objects.messageform;if(d){if(!b&&this.env.is_sent)return this.show_popup_dialog(this.get_label("messageissent"),"",[{text:this.get_label("save"),"class":"mainaction",click:function(){f.submit_messageform(!1,!0);$(this).dialog("close")}},{text:this.get_label("cancel"),click:function(){$(this).dialog("close")}}]);if(this.mailvelope_editor)return this.mailvelope_submit_messageform(a,b);var e=this.set_busy(!0,a||b?"savingmessage":"sendingmessage"),g=this.spellcheck_lang(),k=[];$("li",
this.gui_objects.attachmentlist).each(function(){k.push(this.id.replace(/^rcmfile/,""))});$('input[name="_attachments"]',d).val(k.join());d.target="savetarget";d._draft.value=a?"1":"";d.action=this.add_url(d.action,"_unlock",e);d.action=this.add_url(d.action,"_lang",g);d.action=this.add_url(d.action,"_framed",1);b&&(d.action=this.add_url(d.action,"_saveonly",1));this.submit_timer=setTimeout(function(){f.set_busy(!1,null,e);f.display_message(f.get_label("requesttimedout"),"error")},1E3*this.env.request_timeout);
d.submit()}};this.compose_recipient_select=function(a){var b,d=0;for(b=0;b<a.selection.length;b++){var e=a.selection[b];this.env.contactdata[e]&&d++}this.enable_command("add-recipient",d)};this.compose_add_recipient=function(a){a||(a=$(this.env.focused_field).filter(":visible"),a=a.length?a.attr("id").replace("_",""):"to");var b=[],d=$("#_"+a),e=this.env.recipients_delimiter;if(this.contact_list&&this.contact_list.selection.length)for(var g,f=0;f<this.contact_list.selection.length;f++)if((g=this.contact_list.selection[f])&&
this.env.contactdata[g]&&(b.push(this.env.contactdata[g]),"E"==g.charAt(0)&&0>this.env.contactdata[g].indexOf("@")&&d.length)){var h=g.substr(1);this.group2expand[h]={name:this.env.contactdata[g],input:d.get(0)};this.http_request("group-expand",{_source:this.env.source,_gid:h},!1)}b.length&&d.length&&(g=d.val(),f=new RegExp(RegExp.escape(e)+"\\s*$"),g&&!f.test(g)&&(g+=e+" "),d.val(g+b.join(e+" ")+e+" ").change(),this.triggerEvent("add-recipient",{field:a,recipients:b}));return b.length};this.check_compose_input=
function(a){var b=$("[name='_to']"),d=$("[name='_cc']"),e=$("[name='_bcc']"),g=$("[name='_from']"),k=$("[name='_subject']");if("text"==g.prop("type")&&!rcube_check_email(g.val(),!0))return alert(this.get_label("nosenderwarning")),g.focus(),!1;d=b.val()?b.val():d.val()?d.val():e.val();if(!rcube_check_email(d.replace(/^\s+/,"").replace(/[\s,;]+$/,""),!0))return alert(this.get_label("norecipientwarning")),b.focus(),!1;for(var h in this.env.attachments)if("object"===typeof this.env.attachments[h]&&!this.env.attachments[h].complete)return alert(this.get_label("notuploadedwarning")),
!1;if(""==k.val()){b={};var l=$('<div class="prompt">').html('<div class="message">'+this.get_label("nosubjectwarning")+"</div>").appendTo(document.body),n=$("<input>").attr({type:"text",size:30}).val(this.get_label("nosubject")).appendTo(l),m=function(){k.val(n.val());l.dialog("close");f.command(a,{nocheck:!0})};b[this.get_label("sendmessage")]=function(){m($(this))};b[this.get_label("cancel")]=function(){k.focus();$(this).dialog("close")};l.dialog({modal:!0,resizable:!1,buttons:b,close:function(a,
b){$(this).remove()}});n.select().keydown(function(a){13==a.which&&m()});return!1}if(!this.mailvelope_editor&&!this.editor.get_content()&&!confirm(this.get_label("nobodywarning")))return this.editor.focus(),!1;this.editor.save();return!0};this.toggle_editor=function(a,b,d){b=this.editor.toggle(a.html,a.noconvert||!1);a.mode=a.html?"html":"plain";!b&&d&&(a.mode=a.html?"plain":"html",$(d.target).filter("select").val(a.mode));b&&$("input[name='_is_html']").val(a.html?1:0);return b};this.insert_response=
...
this.change_identity=function(a,b){if(!a||!a.options)return!1;b||(b=this.env.show_sig);var d=a.options[a.selectedIndex].value,e=this.env.identity,g=this.env.recipients_separator,k=RegExp.escape(g);this.env.signatures&&this.env.signatures[d]?(this.enable_command("insert-sig",!0),this.env.compose_commands.push("insert-sig")):this.enable_command("insert-sig",!1);if(!this.env.identities_initialized&&(this.env.identities_initialized=!0,this.env.show_sig_later&&(this.env.show_sig=!0),this.env.opened_extwin))return;
$.each(["replyto","bcc"],function(){var a=e&&f.env.identities[e]?f.env.identities[e][this]:"",b=d&&f.env.identities[d]?f.env.identities[d][this]:"",n=$('[name="_'+this+'"]'),m=n.val();if(a&&m){var q=new RegExp("\\s*"+RegExp.escape(a)+"\\s*");m=m.replace(q,"")}q=new RegExp(k+"\\s*"+k,"g");m=String(m).replace(q,g);q=new RegExp("^[\\s"+k+"]+");m=m.replace(q,"");b&&-1==m.indexOf(b)&&-1==m.indexOf(b.replace(/"/g,""))&&(m&&(q=new RegExp("["+k+"\\s]+$"),m=m.replace(q,"")+g+" "),m+=b+g+" ");(a||b)&&n.val(m).change()});
this.editor.change_signature(d,b);this.env.identity=d;this.triggerEvent("change_identity");return!0};this.upload_file=function(a,b,d){if(a){var e=0,g=0;$("input[type=file]",a).each(function(a,b){var d=b.files?b.files.length:b.value?1:0;if(b.files)for(a=0;a<d;a++)e+=b.files[a].size;g+=d});if(g){if(this.env.max_filesize&&this.env.filesizeerror&&e>this.env.max_filesize)return this.display_message(this.env.filesizeerror,"error"),!1;b=this.async_upload_form(a,b||"upload",function(a){var b="";try{if(this.contentDocument)var e=
this.contentDocument;else this.contentWindow&&(e=this.contentWindow.document);b=e.childNodes[1].innerHTML}catch(q){}b.match(/add2attachment/)||bw.opera&&(!f.env.uploadframe||f.env.uploadframe!=a.data.ts)||(b.match(/display_message/)||f.display_message(f.get_label("fileuploaderror"),"error"),f.remove_from_attachment_list(a.data.ts),d&&f.set_busy(!1,null,d));bw.opera&&(f.env.uploadframe=a.data.ts)});var k="<span>"+this.get_label("uploading"+(1<g?"many":""))+"</span>",h=b.replace(/^rcmupload/,"");this.add2attachment_list(h,
{name:"",html:k,classname:"uploading",frame:b,complete:!1});this.env.upload_progress_time&&this.upload_progress_start("upload",h);this.gui_objects.attachmentform=a;return!0}}};this.add2attachment_list=function(a,b,d){d&&this.triggerEvent("fileuploaded",{name:a,attachment:b,id:d});this.env.attachments||(this.env.attachments={});d&&this.env.attachments[d]&&delete this.env.attachments[d];this.env.attachments[a]=b;if(!this.gui_objects.attachmentlist)return!1;!b.complete&&this.env.loadingicon&&(b.html=
...
this.ksearch_value)){var e,g=this.ksearch_value,k=this.env.autocomplete_max?this.env.autocomplete_max:15;this.ksearch_pane||(b=$("<ul>"),this.ksearch_pane=$("<div>").attr("id","rcmKSearchpane").attr("role","listbox").css({position:"absolute","z-index":3E4}).append(b).appendTo(document.body),this.ksearch_pane.__ul=b[0]);b=this.ksearch_pane.__ul;if(d&&this.ksearch_pane.data("reqid")==d)k-=b.childNodes.length;else{this.ksearch_pane.data("reqid",d);b.innerHTML="";this.env.contacts=[];var h=$(this.ksearch_input).offset();
this.ksearch_pane.css({left:h.left+"px",top:h.top+this.ksearch_input.offsetHeight+"px",display:"none"})}if(a&&(e=a.length))for(h=0;h<e&&0<k;h++){var l="object"===typeof a[h]?a[h].display||a[h].name:a[h];var n="object"===typeof a[h]?a[h].type:"";var m=h+this.env.contacts.length;$("<li>").attr("id","rcmkSearchItem"+m).attr("role","option").html('<i class="icon"></i>'+this.quote_html(l.replace(new RegExp("("+RegExp.escape(g)+")","ig"),"##$1%%")).replace(/##([^%]+)%%/g,"<b>$1</b>")).addClass(n||"").appendTo(b).mouseover(function(){f.ksearch_select(this)}).mouseup(function(){f.ksearch_click(this)}).get(0)._rcm_id=
m;--k}b.childNodes.length&&($(this.ksearch_input).attr("aria-haspopup","true").attr("aria-expanded","true").attr("aria-owns","rcmKSearchpane"),this.ksearch_pane.show(),this.env.contacts.length||this.ksearch_select($("li:first",b).get(0)));e&&(this.env.contacts=this.env.contacts.concat(a));this.ksearch_data.id==d&&this.ksearch_data.num--}};this.ksearch_click=function(a){this.ksearch_input&&this.ksearch_input.focus();this.insert_recipient(a._rcm_id);this.ksearch_hide()};this.ksearch_blur=function(){this.ksearch_timer&&
...
this.env.search_id||this.select_folder(g,"",!0);if(this.gui_objects.contactslist)this.list_contacts_remote(a,b,d);else{if(e=this.get_frame_window(this.env.contentframe))n=e,h._framed=1;b&&(h._gid=b);d&&(h._page=d);a&&(h._source=a);this.env.search_request&&(h._search=this.env.search_request);this.set_busy(!0,"loading");this.location_href(h,n)}};this.list_contacts_remote=function(a,b,d){this.list_contacts_clear();var e={},g=this.set_busy(!0,"loading");a&&(e._source=a);d&&(e._page=d);b&&(e._gid=b);this.env.source=
...
b,d){var e=$("#ff_"+a);if(e.length)e.show().focus(),$(d).children('option[value="'+a+'"]').prop("disabled",!0);else{$(".ff_"+a);e=$("#contactsection"+b+" .contactcontroller"+a);if(!e.length){b=$("#contactsection"+b);var g=$(".contactfieldgroup",b).last();e=$("<fieldset>").addClass("contactfieldgroup contactcontroller"+a);g.length?e.insertAfter(g):b.prepend(e)}if(e.length&&"FIELDSET"==e.get(0).nodeName){b=this.env.coltypes[a];var k="ff_"+a+(b.count||0);g=$("<div>").addClass("row");var h=$("<div>").addClass("contactfieldcontent data"),
l=$("<div>").addClass("contactfieldlabel label");b.subtypes_select?l.html(b.subtypes_select):l.html('<label for="'+k+'">'+b.label+"</label>");var n=1!=b.limit?"[]":"";if("text"==b.type||"date"==b.type){var m=$("<input>").addClass("ff_"+a).attr({type:"text",name:"_"+a+n,size:b.size,id:k}).appendTo(h);this.init_edit_field(a,m);"date"==b.type&&$.datepicker&&m.datepicker()}else if("textarea"==b.type)m=$("<textarea>").addClass("ff_"+a).attr({name:"_"+a+n,cols:b.size,rows:b.rows,id:k}).appendTo(h),this.init_edit_field(a,
m);else if("composite"==b.type){var q,p=[],u=[];if(m=this.env[a+"_template"])for(k=0;k<m.length;k++)p.push(m[k][1]),u.push(m[k][2]);else for(v in b.childs)p.push(v);for(k=0;k<p.length;k++){var v=p[k];m=b.childs[v];m=$("<input>").addClass("ff_"+v).attr({type:"text",name:"_"+v+n,size:m.size}).appendTo(h);h.append(u[k]||" ");this.init_edit_field(v,m);q||(q=m)}m=q}else if("select"==b.type){m=$("<select>").addClass("ff_"+a).attr({name:"_"+a+n,id:k}).appendTo(h);var x=m.attr("options");x[x.length]=new Option("---",
"");b.options&&$.each(b.options,function(a,b){x[x.length]=new Option(b,a)})}m&&($('<a href="#del"></a>').addClass("contactfieldbutton deletebutton").attr({title:this.get_label("delete"),rel:a}).html(this.env.delbutton).click(function(){f.delete_edit_field(this);return!1}).appendTo(h),g.append(l).append(h).appendTo(e.show()),m.first().focus(),b.count||(b.count=0),++b.count==b.limit&&b.limit&&$(d).children('option[value="'+a+'"]').prop("disabled",!0))}}};this.delete_edit_field=function(a){var b=$(a).attr("rel"),
...
function(a){a.query&&f.subscription_select()}).draggable({cancel:"li.mailbox.root,input,div.treetoggle"}).droppable({accept:function(a){if(!$(a).is(".mailbox"))return!1;a=f.folder_id2name($(a).attr("id"));var b=f.folder_id2name(this.id),e=f.env.subscriptionrows[a];return e&&!e[2]&&b!=a.replace(f.last_sub_rx,"")&&!b.startsWith(a+f.env.delimiter)},drop:function(a,d){a=f.folder_id2name(d.draggable.attr("id"));d=f.folder_id2name(this.id);f.subscription_move_folder(a,d)}})};this.folder_id2name=function(a){return a?
...
d;b!=a&&this.http_post("rename-folder",{_folder_oldname:a,_folder_newname:b},this.set_busy(!0,"foldermoving"))}};this.create_folder=function(){this.show_folder("",this.env.mailbox)};this.delete_folder=function(a){a||(a=this.env.mailbox);a&&confirm(this.get_label("deletefolderconfirm"))&&this.http_post("delete-folder",{_mbox:a},this.set_busy(!0,"folderdeleting"))};this.add_folder_row=function(a,b,d,e,g,k,h,l){if(!this.gui_objects.subscriptionlist)return!1;this.subscription_list.is_search()&&(this.subscription_select(),
this.subscription_list.reset_search());this.subscription_list.draggable("destroy").droppable("destroy");var n,m,q="",p=[],u=[],v=[],x=$(this.gui_objects.subscriptionlist);var t=h?h:$($("li",x).get(1)).clone(!0);if(!t.length)return this.goto_url("folders"),!1;t.attr({id:"rcmli"+this.html_identifier_encode(a),"class":k});h&&h.length||($("ul,div.treetoggle",t).remove(),t.removeData("filtered"));$("a:first",t).text(d);$('input[name="_subscribed[]"]:first',t).val(a).prop({checked:g?!0:!1,disabled:e?!0:
!1});this.env.subscriptionrows[a]=[b,d,!1];$.each(this.env.subscriptionrows,function(a,b){b[3]=a;p.push(b)});try{var w=new Intl.Collator(this.env.locale.replace("_","-"))}catch(z){}p.sort(function(a,b){a=a[0].split(f.env.delimiter);var d=b[0].split(f.env.delimiter),e=a.length;for(b=0;b<e;b++){var g=a[b];var k=d[b];if(g!==k)return void 0===k?1:w?w.compare(g,k):g<k?-1:1;if(b==e-1)return-1}});for(n in p)if(d=p[n][3],p[n][2]){if(b=d+this.env.delimiter,b!=this.env.prefix_ns){v.push(d);var y=b}}else y&&
d.startsWith(y)?v.push(d):(u.push(d),y=null);for(n=0;n<v.length;n++)a.startsWith(v[n]+this.env.delimiter)&&(m=v[n]);for(n=0;!m&&n<u.length;n++)n&&u[n]==a&&(m=u[n-1]);if(m&&(n=this.subscription_list.get_item(m,!0))){if(y=a.lastIndexOf(this.env.delimiter))q=a.substring(0,y),q=this.subscription_list.get_item(q,!0),$("div.treetoggle",q).length||$("<div>&nbsp;</div>").addClass("treetoggle collapsed").appendTo(q),$("ul",q).length||$("<ul>").css("display","none").appendTo(q);if(q&&n==q)$("ul:first",q).append(t);
else{for(;(d=$(n).parent().parent().get(0))&&(!q||d!=q)&&$(d).is("li.mailbox");)n=d;$(n).after(t)}}else x.append(t);$.extend(this.env.subscriptionrows,l||{});this.subscription_list.reset(!0);this.subscription_select();q&&this.subscription_list.expand(this.folder_id2name(q.id));t=t.show().get(0);t.scrollIntoView&&t.scrollIntoView();return t};this.replace_folder_row=function(a,b,d,e,g,k){if(!this.gui_objects.subscriptionlist)return this.is_framed()?window.parent.rcmail.replace_folder_row(a,b,d,e,g,
k):!1;this.subscription_list.is_search()&&(this.subscription_select(),this.subscription_list.reset_search());var h={},l=this.subscription_list.get_item(a,!0),n=$(l).parent(),m=a.length,q=this.env.subscriptionrows[a][0].length,p=$('input[name="_subscribed[]"]:first',l).prop("checked");a==b?$(l).attr("class",k||""):($("li",l).each(function(){var a=f.folder_id2name(this.id),e=f.env.subscriptionrows[a],g=b+a.slice(m);this.id="rcmli"+f.html_identifier_encode(g);$('input[name="_subscribed[]"]:first',this).val(g);
e[0]=d+e[0].slice(q);h[g]=e;delete f.env.subscriptionrows[a]}),l=$(l).detach(),delete this.env.subscriptionrows[a],n.get(0)==this.gui_objects.subscriptionlist||$("li",n).length||$("ul,div.treetoggle",n.parent()).remove(),this.add_folder_row(b,d,e,g,p,k,l,h))};this.remove_folder_row=function(a){this.subscription_list.is_search()&&(this.subscription_select(),this.subscription_list.reset_search());var b=[],d=this.subscription_list.get_item(a,!0);$("li",d).each(function(){b.push(f.folder_id2name(this.id))});
...
$('<div class="popup">');"object"==typeof a?g.append(a):g.html(a);e=$.extend({title:b,buttons:d,modal:!0,resizable:!0,width:500,close:function(a,b){$(this).remove()}},e||{});g.dialog(e);b=$(window);a=b.width();b=b.height();var f=g.width(),h=g.height();g.dialog("option",{height:Math.min(b-40,h+75+(d?50:0)),width:Math.min(a-20,f+36)});$.each(e.button_classes||[],function(a,b){b&&$($(".ui-dialog-buttonpane button.ui-button",g.parent()).get(a)).addClass(b)});return g};this.set_page_buttons=function(){this.enable_command("nextpage",
...
function(a){this[(a?"un":"")+"mark_folder"](this.env.trash_mailbox,"empty","",!0)};this.set_unread_count=function(a,b,d,e){if(!this.gui_objects.mailboxlist)return!1;this.env.unread_counts[a]=b;this.set_unread_count_display(a,d);e?this.mark_folder(a,e,"",!0):b||this.unmark_folder(a,"recent","",!0)};this.set_unread_count_display=function(a,b){var d,e;if(d=this.get_folder_li(a,"",!0)){var f=this.env.unread_counts[a]?this.env.unread_counts[a]:0;var k=$(d).children("a").eq(0);var h=k.children("span.unreadcount");
!h.length&&f&&(h=$("<span>").addClass("unreadcount").appendTo(k));k=0;if((e=d.getElementsByTagName("div")[0])&&e.className.match(/collapsed/))for(var l in this.env.unread_counts)l.startsWith(a+this.env.delimiter)&&(k+=this.env.unread_counts[l]);f&&h.length?h.html(this.env.unreadwrap.replace(/%[sd]/,f)):h.length&&h.remove();h=new RegExp(RegExp.escape(this.env.delimiter)+"[^"+RegExp.escape(this.env.delimiter)+"]+$");a.match(h)&&this.set_unread_count_display(a.replace(h,""),!1);0<f+k?$(d).addClass("unread"):
$(d).removeClass("unread")}h=/^\([0-9]+\)\s+/i;b&&document.title&&(a=String(document.title),f=f&&a.match(h)?a.replace(h,"("+f+") "):f?"("+f+") "+a:a.replace(h,""),this.set_pagetitle(f))};this.set_headers=function(a){this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&a&&$(this.gui_objects.all_headers_box).html(a).show()};this.show_headers=function(a,b){this.gui_objects.all_headers_row&&this.gui_objects.all_headers_box&&this.env.uid&&($(b).removeClass("show-headers").addClass("hide-headers"),
...
"",b)})};this.folder_selector=function(a,b){var d=this.folder_selector_element;if(!d){var e=[],g=this.env.delimiter,k=$('<ul class="toolbarmenu">'),h=document.createElement("a");d=$('<div id="folder-selector" class="popupmenu"></div>');h.href="#";h.className="icon";$.each(this.env.mailboxes_list,function(){var a=0,b=0,d=f.env.mailboxes[this],k=d.id,p=$(h.cloneNode(!1)),u=$("<li>");d.virtual?p.addClass("virtual").attr("aria-disabled","true").attr("tabindex","-1"):p.addClass("active").data("id",d.id);
for(d["class"]&&p.addClass(d["class"]);0<=(b=k.indexOf(g,b));)a++,b++;p.css("padding-left",a?16*a+"px":0);p.append($("<span>").text(d.name));u.append(p);e.push(u)});k.append(e).appendTo(d);d.css({left:"-1000px",top:"-1000px"}).appendTo($("body")).show();10<e.length&&d.css("max-height",10*$("li",d)[0].offsetHeight+9);d.on("click","a.active",function(a){d.data("callback")($(this).data("id"));return!1});this.folder_selector_element=d}d.data("callback",b);this.show_menu("folder-selector",!0,a)};this.show_menu=
function(a,b,d){var e="object"==typeof a?a.menu:a,f=$("#"+e),k=d&&d.target?$(d.target):$(f.attr("rel")||"#"+e+"link"),h=rcube_event.is_keyboard(d),l=f.attr("data-align")||"",n=!1;"A"!=k.get(0).tagName&&k.closest("a").length&&(k=k.closest("a"));"string"==typeof a&&(a={menu:e});f.length||(f=this.triggerEvent("menu-get",{name:e,props:a,originalEvent:d}));if(!f||!f.length)return this.triggerEvent(!1===b?"menu-close":"menu-open",{name:e,props:a,originalEvent:d});f.appendTo(document.body);"undefined"==
typeof b&&(b=f.is(":visible")?!1:!0);if(b&&k.length){var m=$(window),q=k.offset(),p=0<=l.indexOf("bottom");n="menuitem"==k.attr("role")||0<k.closest("[role=menuitem]").length;k.offsetWidth=k.outerWidth();k.offsetHeight=k.outerHeight();!p&&q.top+k.offsetHeight+f.height()>m.height()&&(p=!0);0<=l.indexOf("right")?q.left=q.left+k.outerWidth()-f.width():n&&(q.left=q.left+k.offsetWidth-5,q.top-=k.offsetHeight);q.left+f.width()>m.width()&&(q.left=m.width()-f.width()-12);q.top=Math.max(0,q.top+(p?-f.height():
k.offsetHeight));f.css({left:q.left+"px",top:q.top+"px"})}if(b){for(l=this.menu_stack.length-1;n&&0<=l;l--)$(k).parents("#"+this.menu_stack[l]).length||"menuitem"==$(d.target).parent().attr("role")||this.hide_menu(this.menu_stack[l],d);n&&this.menu_stack.length?(f.data("parent",$.last(this.menu_stack)),f.css("z-index",($("#"+$.last(this.menu_stack)).css("z-index")||0)+1)):!n&&this.menu_stack.length&&this.hide_menu(this.menu_stack[0],d);f.show().attr("aria-hidden","false").data("opener",k.attr("aria-expanded",
...
!1)}else this.triggerEvent("menu-close",{name:a,props:{menu:a},originalEvent:b})};this.element_position=function(a,b){b=$(b);var d=$(window),e=b.outerWidth(),f=b.outerHeight(),k=b.data("menu-pos"),h=d.height(),l=$(a).height(),n=$(a).width(),m=b.offset();b=m.top;m=m.left+e;"bottom"==k?(b+=f,m-=e):m-=5;b+l>h&&(b-=l-f,0>b&&(b=Math.max(0,(h-l)/2)));m+n>d.width()&&(m-=n+e);a.css({left:m+"px",top:b+"px"})};this.editor_init=function(a,b){this.editor=new rcube_text_editor(a,b)};this.html2plain=function(a,
...
g&&setTimeout(function(){f.keep_alive();f.start_keepalive()},3E4))};this.session_error=function(a){this.env.server_error=401;"compose"==this.env.action?(this.save_compose_form_local(),this.compose_skip_unsavedcheck=!0):a&&setTimeout(function(){f.redirect(a,!0)},2E3)};this.iframe_loaded=function(a){this.set_busy(!1,null,a);this.submit_timer&&clearTimeout(this.submit_timer)};this.multi_thread_http_request=function(a){var b,d=(new Date).getTime(),e=a.threads||1;a.reqid=d;a.running=0;a.requests=[];a.result=
[];a._items=$.extend([],a.items);a.lock||(a.lock=this.display_message(this.get_label("loading"),"loading"));this.http_request_jobs[d]=a;for(b=0;b<e;b++){var f=a._items.shift();if(void 0===f)break;a.running++;a.requests.push(this.multi_thread_send_request(a,f))}return d};this.multi_thread_send_request=function(a,b){var d;if(a.postdata){var e={};for(d in a.postdata)e[d]=String(a.postdata[d]).replace("%s",b);e._reqid=a.reqid}else if("string"==typeof a.query){var f=a.query.replace("%s",b);f+="&_reqid="+
a.reqid}else if("object"==typeof a.query&&a.query){f={};for(d in a.query)f[d]=String(a.query[d]).replace("%s",b);f._reqid=a.reqid}return e?this.http_post(a.action,e):this.http_request(a.action,f)};this.multi_thread_http_response=function(a,b){var d=this.http_request_jobs[b];if(!(!d||0>=d.running||d.cancelled)){d.running--;if(d.onresponse&&"function"==typeof d.onresponse)d.onresponse(a);d.result=$.extend(d.result,a);a=d._items.shift();void 0!==a?(d.running++,d.requests.push(this.multi_thread_send_request(d,
a))):0==d.running&&(d.whendone&&"function"==typeof d.whendone&&d.whendone(d.result),this.set_busy(!1,"",d.lock),delete this.http_request_jobs[b])}};this.multi_thread_request_abort=function(a){if(a=this.http_request_jobs[a]){for(var b=0;0<a.running&&b<a.requests.length;b++)a.requests[b].abort&&a.requests[b].abort();a.running=0;a.cancelled=!0;this.set_busy(!1,"",a.lock)}};this.async_upload_form=function(a,b,d){var e=(new Date).getTime(),f="rcmupload"+e,k=this.async_upload_form_frame(f);if(this.env.upload_progress_name){var h=
this.env.upload_progress_name,l=$("input[name="+h+"]",a);l.length||(l=$("<input>").attr({type:"hidden",name:h}),l.prependTo(a));l.val(e)}k.on("load",{ts:e},d);$(a).attr({target:f,action:this.url(b,{_id:this.env.compose_id||"",_uploadid:e,_from:this.env.action}),method:"POST"}).attr(a.encoding?"encoding":"enctype","multipart/form-data").submit();return f};this.async_upload_form_frame=function(a){return $("<iframe>").attr({name:a,style:"border: none; width: 0; height: 0; visibility: hidden"}).appendTo(document.body)};
this.document_drag_hover=function(a,b){$(this.gui_objects.filedrop)[b?"addClass":"removeClass"]("active")};this.file_drag_hover=function(a,b){a.preventDefault();a.stopPropagation();$(this.gui_objects.filedrop)[b?"addClass":"removeClass"]("hover")};this.file_dropped=function(a){this.file_drag_hover(a,!1);var b,d=a.target.files||a.dataTransfer.files,e=window.FormData?new FormData:null,g=(this.env.filedrop.fieldname||"_file")+(this.env.filedrop.single?"":"[]"),k="------multipartformboundary"+(new Date).getTime(),
h="--"+k+"\r\n",l={_id:this.env.compose_id||this.env.cid||"",_remote:1,_from:this.env.action};if(d&&d.length)for(var n=function(){var a=1<d.length,b=(new Date).getTime();a=$("<span>").text(a?f.get_label("uploadingmany"):d[0].name).html();f.add2attachment_list(b,{name:"",html:a,classname:"uploading",complete:!1})||(f.file_upload_id=f.set_busy(!0,"uploading"));h+="--"+k+"--\r\n";l._uploadid=b;$.ajax({type:"POST",dataType:"json",url:f.url(f.env.filedrop.action||"upload",l),contentType:e?!1:"multipart/form-data; boundary="+
k,processData:!1,timeout:0,data:e||h,headers:{"X-Roundcube-Request":f.env.request_token},xhr:function(){var a=jQuery.ajaxSettings.xhr();!e&&a.sendAsBinary&&(a.send=a.sendAsBinary);return a},success:function(a){f.http_response(a)},error:function(a,b,d){f.http_error(a,b,d,null,"attachment")}})},m=this.env.filedrop.single?0:d.length-1,q=b=0,p;b<=m&&(p=d[q]);q++){if(p.name||(p.name=p.fileName),p.size||(p.size=p.fileSize),p.type||(p.type="application/octet-stream"),!e&&/[^\x20-\x7E]/.test(p.name)&&(p.name_bin=
unescape(encodeURIComponent(p.name))),!this.env.filedrop.filter||p.type.match(new RegExp(this.env.filedrop.filter))){if(e){if(e.append(g,p),b==m)return n()}else if(window.FileReader){var u=new FileReader;u.onload=function(a,b){return function(d){h+='Content-Disposition: form-data; name="'+g+'"';h+='; filename="'+(p.name_bin||a.name)+'"\r\n';h+="Content-Length: "+a.size+"\r\n";h+="Content-Type: "+a.type+"\r\n\r\n";h+=u.result+"\r\n";h+="--"+k+"\r\n";if(b==m)return n()}}(p,b);u.readAsBinaryString(p)}else if(p.getAsBinary&&
(h+='Content-Disposition: form-data; name="'+g+'"',h+='; filename="'+(p.name_bin||p.name)+'"\r\n',h+="Content-Length: "+p.size+"\r\n",h+="Content-Type: "+p.type+"\r\n\r\n",h+=p.getAsBinary()+"\r\n",h+="--"+k+"\r\n",b==m))return n();b++}}else if(b=a.dataTransfer.getData("roundcube-uri"))q=(new Date).getTime(),a=$("<span>").text(a.dataTransfer.getData("roundcube-name")||this.get_label("attaching")).html(),l._uri=b,l._uploadid=q,this.add2attachment_list(q,{name:"",html:a,classname:"uploading",complete:!1})||
...
if("ActiveXObject"in window){try{return a=new ActiveXObject("AcroPDF.PDF"),1}catch(g){}try{return a=new ActiveXObject("PDF.PdfCtrl"),1}catch(g){}}for(i=0;i<d;i++)if(a=b[i],"String"===typeof a){if(e.test(a))return 1}else if(a.name&&e.test(a.name))return 1;window.setTimeout(function(){$("<object>").css({position:"absolute",left:"-10000px"}).attr({data:f.assets_path("program/resources/dummy.pdf"),width:1,height:1,type:"application/pdf"}).load(function(){f.env.browser_capabilities.pdf=1}).error(function(){f.env.browser_capabilities.pdf=
...
this.env.cookie_secure)};this.get_local_storage_prefix=function(){this.local_storage_prefix||(this.local_storage_prefix="roundcube."+(this.env.user_id||"anonymous")+".");return this.local_storage_prefix};this.local_storage_get_item=function(a,b,d){try{var e=localStorage.getItem(this.get_local_storage_prefix()+a);var f=JSON.parse(e)}catch(k){}return f||b||null};this.local_storage_set_item=function(a,b,d){try{return localStorage.setItem(this.get_local_storage_prefix()+a,JSON.stringify(b)),!0}catch(e){return!1}};
this.local_storage_remove_item=function(a){try{return localStorage.removeItem(this.get_local_storage_prefix()+a),!0}catch(b){return!1}};this.print_dialog=function(){bw.safari?setTimeout("window.print()",10):window.print()}}rcube_webmail.long_subject_title=function(f,w){if(!f.title){var a=$(f);a.width()+15*(w||0)>a.parent().width()&&(f.title=rcube_webmail.subject_text(f))}};
rcube_webmail.long_subject_title_ex=function(f){if(!f.title){var w=$(f),a=$.trim(w.text());a=$("<span>").text(a).css({position:"absolute","float":"left",visibility:"hidden","font-size":w.css("font-size"),"font-weight":w.css("font-weight")}).appendTo($("body"));var b=a.width();a.remove();b+15*$("span.branch",w).width()>w.width()&&(f.title=rcube_webmail.subject_text(f))}};rcube_webmail.subject_text=function(f){f=$(f).clone();f.find(".skip-on-drag").remove();return f.text()};
rcube_webmail.set_iframe_events=function(f){$("iframe").each(function(){var w=$(this);$.each(f,function(a,b){w.on("load",function(d){try{$(this).contents().on(a,b)}catch(e){}});try{w.contents().on(a,b)}catch(d){}})})};rcube_webmail.prototype.get_cookie=getCookie;rcube_webmail.prototype.addEventListener=rcube_event_engine.prototype.addEventListener;rcube_webmail.prototype.removeEventListener=rcube_event_engine.prototype.removeEventListener;rcube_webmail.prototype.triggerEvent=rcube_event_engine.prototype.triggerEvent;
